...
from .views import index, NewsletterListView, NewsletterCreateView, MessageCreateView, MessageListView, CustomerListView, CustomerCreateView
...
urlpatterns = [
    ...
    path('assign_permission/<int:newsletter_id>/<str:username>/', views.assign_permission_view, name='assign_permission'),
]
